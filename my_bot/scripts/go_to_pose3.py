...
class GoToPose3(Node):

    def __init__(self):
        super().__init__('go_to_pose3')
        ...
        self.waypoints = [
            ...
            {'x': 1.689, 'y': 1.235, **quaternion_right},  # Menghadap ke kanan
            {'x': 2.550, 'y': 1.235, **quaternion_up},  # Menghadap ke atas
            {'x': 2.550, 'y': 2.184, **quaternion_up},  # Menghadap ke atas
            {'x': 2.550, 'y': 2.426, **quaternion_left},  # Menghadap ke kiri
            {'x': 2.296, 'y': 2.426, **quaternion_right},  # Menghadap ke kanan
        ]
        self.return_waypoints = [
            {'x': 2.550, 'y': 2.426, **quaternion_down},  # Menghadap ke kanan
            {'x': 2.550, 'y': 2.184, **quaternion_down},  # Menghadap ke kanan
            {'x': 2.550, 'y': 1.235, **quaternion_left},  # Menghadap ke bawah
            {'x': 1.689, 'y': 1.235, **quaternion_up},  # Menghadap ke kiri
