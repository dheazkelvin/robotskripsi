...
class GoToPose5(Node):

    def __init__(self):
        super().__init__('go_to_pose5')
        ...
        self.waypoints = [
            ...
            {'x': 2.550, 'y': 1.235, **quaternion_down},  # Menghadap ke atas
            {'x': 2.550, 'y': 0.637, **quaternion_down},  # Menghadap ke atas
            {'x': 2.502, 'y': -0.134, **quaternion_up},  # Menghadap ke kiri
        ]
        self.return_waypoints = [
            {'x': 2.550, 'y': 0.637, **quaternion_up},  # Menghadap ke atas
